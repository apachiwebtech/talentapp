            ...
            {post?.map((item, index) => {
                ...
                return (
                    <div className="posty">
                                ...
                                <Carousel>
                                    <div className='post-main-img' id='postclick'>
                                        {item?.post_images?.[0] && item.post_images?.[0].endsWith('.mp4') ? (
                                            <ReactPlayer url={`https://thetalentclub.co.in/upload/group_post_files/${item.post}`} loop={false} playing={false} controls={true} playIcon={<button>Play</button>} />
                                        ) : (
                                            <>
                                                {loading && <div><img src={loader} style={{ width: "70px", position: 'absolute', left: "50%", transform: "translateX(-50%)" }} alt='' /></div>}
                                                {/* <SlideshowLightbox iconColor="#000" backgroundColor='#fff'> */}
                                                <img
                                                    src={'https://thetalentclub.co.in/upload/group_post_files/' + item.post}
                                                    alt=''
                        ...
                        {post?.length == 0 && <div className='card text-center p-3'>
